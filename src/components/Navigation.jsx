  ...
  return (
    <>
      <div className="flex justify-between desktop:justify-normal items-center flex-row desktop:flex-col desktop:fixed desktop:top-8 desktop:bottom-8 desktop:left-8 bg-semi-dark-blue tablet:m-6 tablet:rounded-[0.625rem] desktop:rounded-[1.25rem] desktop:m-0 desktop:min-w-24">
        <img
          className="m-4 w-5 h-auto tablet:w-8 tablet:m-6 desktop:w-8 desktop:m-8"
          src={logo}
          alt="logo"
        />
        <div className="flex flex-row desktop:flex-col desktop:mt-[4.65rem]">
          <Link to="/home">
            <svg
              ...
              className="hover:fill-red h-4 ml-3 mr-3 tablet:h-5 tablet:ml-4 tablet:m-4 desktop:w-5 desktop:h-auto"
              fill="#5A698F"
            >
