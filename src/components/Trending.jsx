              ...
              return (
                <div key={index} className="relative text-white ">
                  <img
                    ...
                    alt="MovieIcon"
                    className="absolute w-[2rem] h-[2rem] top-[0.5rem] right-[0.5rem]"
                  />
                  <img
                    src={thumbnail.regular.small}
                    alt="#"
                    className="min-w-[15rem] min-h-[8.75rem] rounded-[0.5rem]"
                  />
                  <div className="absolute top-[5.37rem] left-[1rem] text-center flex ">
                    ...
                    <img
                      src={movieIcon}
                      alt="MovieIcon"
                      className="w-[0.75rem] h-[0.75rem] mr-[0.38rem] ml-[0.5rem]"
                    />
                    <p>Movie &#8226; {rating}</p>
