...
const Trending = () => {
  ...
  return (
    <>
      <div>
        <h1 className="heading-xs mobile:heading-xs tablet:heading-l text-[1.25rem] pl-[1rem] mobile:pl-[1rem] tablet:pl-[1.56rem] desktop:pl-[2.35rem] tracking-[0.05rem] mobile:mt-[1.4rem] tablet:mt-[0.9rem] tablet:tracking-[0.00215rem] mb-[1rem] mobile:mb-[1rem] tablet:mb-[1.3rem] desktop:mb-[1.4rem]">
          Trending
        </h1>
      </div>
      <div
              ...
              return (
                <div key={show.id} className="relative group/play">
                  ...
                  <picture>
                    ...
                    <button><img src={playButton} alt="playButton" className="mobile:w-[1.4rem] mobile:h-[1.4rem] tablet:w-[1.875rem] tablet:h-[1.875rem] ml-[0.56rem] mobile:mr-[0.6rem] tablet:mr-[1.19rem]" /></button>
