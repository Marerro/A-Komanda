        ...
        return (
          <div key={id} className="relative group/play">
            ...
            <div className="flex place-items-center card_content text-[#FFF]/[0.75] ml-[0.5rem] gap-[0.5rem;] mobile:gap-[0.8rem] text-[0.6875rem] tablet:ml-[1.56rem] tablet:gap-[0.5rem]">
              <p className="mobile:mt-[-0.20rem] mobile:size-[0.6875rem] mobile:translate-y-[-0.13rem]">
                {year}
              </p>
              <span className="mobile:translate-x-[0.3rem] mobile:translate-y-[-0.1rem]">
                &#8226;
              </span>
              {category === "Movie" && (
                <img
                  className="w-[0.625rem] shrink h-[0.625rem] mobile:translate-y-[-0.1rem] mobile:translate-x-[-0.15rem]"
                  src={category_movie}
                  alt="Movie Icon"
                />
              )}
              {category === "TV Series" && (
                <img
                  className="w-[0.625rem] shrink h-[0.625rem] mobile:translate-y-[-0.08rem] mobile:translate-x-[-0.15rem]"
                  src={category_TV}
                  alt="TV Icon"
                />
              )}
              <p className="mobile:mr-[-4px] mobile:mt-[-0.20rem] mobile:translate-x-[-0.68rem] mobile:translate-y-[0.01rem]">
                {category}
              </p>
              <span className="mobile:translate-y-[-0.1rem] mobile:translate-x-[-0.93rem]">
                &#8226;
              </span>
              <p className="mobile:mt-[-0.20rem] mobile:translate-x-[-1.45rem] mobile:translate-y-[-0.15rem] mobile:size-[0.6875rem]">
                {rating}
              </p>
            </div>

            <p className="text-[#FFF] text-[0.875rem] mobile:ml-[0.5rem] tablet:ml-[1.56rem] font-outfit">
              {title}
            </p>
          </div>
        );
