  ...
  return (
    <>
      <div className="flex flex-col place-items-center h-dvh">
        ...
        <h1 className="heading-l pl-[1.5rem] pt-[1.5rem] pb-[2.5rem] tablet:pl-[2rem] tablet:pt-[2rem]">Sign Up</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="pl-[1.5rem] tablet:pl-[2rem]">
          <div className="pb-[1.5rem] relative">
            ...
            <p className="error-text text-red absolute bottom-3 left-[10.84rem] tablet:left-[14.44rem]">{errors.email?.message}</p>
            </div>
          </div>
          <div className="pb-[1.5rem]">
            ...
            />
            <div className="relative">
            <p className="error-text text-red absolute top-[0.1rem] left-[0.5rem]">{errors.password?.message}</p>
            </div>
          </div>
          <div className="pb-[1.5rem]">
            <input
              ...
              className={`bg-semi-dark-blue border-0 border-b-[0.063rem] pb-5 pl-[1rem] tablet:w-[21rem] autofill:transition-colors autofill:duration-[999999999s] ${
                errors.repeatPassword ? "border-red" : "grayish-blue"
              }`}
            />
            <div className="relative">
