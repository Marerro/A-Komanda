...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <div className="flex justify-between desktop:justify-normal items-center flex-row desktop:flex-col z-30 sticky top-0 tablet:top-6 desktop:fixed desktop:top-8 desktop:bottom-8 desktop:left-8 bg-semi-dark-blue tablet:m-6 tablet:rounded-[0.625rem] desktop:rounded-[1.25rem] desktop:m-0 desktop:min-w-24"> 
        <img
          className="m-4 h-5 w-auto tablet:h-6 tablet:w-8 tablet:m-6 desktop:w-8 desktop:m-8"
          src={logo}
          alt="logo"
        />
        <div className="flex flex-row desktop:flex-col h-4 tablet:h-5 desktop:mt-[4.65rem]">
          <Link to="/home">
            <svg
              id="home"
              width="16"
              ...
              viewBox="0 0 20 20"
              className="hover:fill-red h-fit mx-3 tablet:h-5 tablet:mx-4 desktop:my-4 desktop:w-5 desktop:h-auto"
              fill="#5A698F"
            >
