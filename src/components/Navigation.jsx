...
export default function Navigation({ setRefresh }) {
        ...
        <div className="flex flex-row desktop:flex-col h-4 tablet:h-5 tablet:mr-4 desktop:mr-0 desktop:mt-10 desktop:h-[13.5rem]">
          ...
          <Link to="/movies">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              className="hover:fill-red h-fit mx-3 tablet:h-5 tablet:w-5 tablet:mx-4 desktop:my-5 desktop:w-5 desktop:h-auto"
              fill="#5A698F"
              onClick={refresh}
            >
          ...
          <Link to="/bookmarks">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="-2 0 20 20"
              className="hover:fill-red h-fit mx-3 tablet:h-5 tablet:w-5 tablet:mr-0 tablet:ml-4 desktop:mt-5 desktop:m-4 desktop:w-5 desktop:h-auto"
              fill="#5A698F"
              onClick={refresh}
            >
